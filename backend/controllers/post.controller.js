...
import { uploadImage } from "../lib/utils/cloudinaryHelpers.js";
...
export const commentOnPosts = async (req, res) => {
  try {
    ...
    console.log("Error in commentOnPosts controller: ", error.message);
    res.status(500).json({ error: error.message || "Internal Server Error" });
  }
};
...
export const likeUnlikePost = async (req, res) => {
  try {
    ...
    const isLikedAlready = post.likes.includes(userId);
    if (isLikedAlready) {
      //unlike post
